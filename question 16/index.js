...
var guest = ["Kareem", "Sumair", "Dawood"];
// Function to shrink the guest list
function shrinkGuestsList(maxsGuests) {
    if (maxsGuests >= guest.length) {
        console.log("No guests need to be removed. You can invite all guests.");
    }
    else {
        var guestsToRemove = guest.length - maxsGuests;
        guest.splice(-guestsToRemove);
        console.log("Guest list shrunk to ".concat(maxsGuests, " guests."));
